...
public class Sdhcp {
    private static final String IPSERVER = "192.168.10.2";
    ...
    private static void enviarRespuesta(byte[] transactionID, byte[] MAC, DatagramSocket s, byte type) {
        ...
        Offer.put((byte) 1);
        Offer.put((byte) 4);
        Offer.put(toByteArray(MASK));
        Offer.put((byte) 6);
        Offer.put((byte) 4);
        Offer.put(toByteArray(DNS));
        Offer.put((byte) 3);
        Offer.put((byte) 4);
        Offer.put(toByteArray(ROUTER));
        Offer.put((byte) 51);
        Offer.put((byte) 4);
        Offer.put((byte) TIEMPOCESION);
        Offer.put((byte) 58);
        Offer.put((byte) 4);
        Offer.put((byte) TIEMPORENOVACION);
        Offer.put((byte) 54);
        Offer.put((byte) 4);
        Offer.put(toByteArray(IPSERVER));
        Offer.put((byte) 255);
